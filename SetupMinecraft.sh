...
Update_Server() {
  ...
  echo "Checking for the latest version of Minecraft Preview Bedrock server..."
  ...
  DownloadURL=$(grep -o 'https://minecraft.azureedge.net/bin-linux-preview/[^"]*' downloads/version.html)
  DownloadFile=$(echo "$DownloadURL" | sed 's#.*/##')
  echo "$DownloadURL"
  echo "$DownloadFile"

  # Download latest version of Minecraft Bedrock dedicated server
  echo "Downloading the latest version of Minecraft Preview Bedrock server..."
  UserName=$(whoami)
